...
write.table(dispersion.csv, file = paste(out.dir,  name, "_DispersionStat2.csv", sep = ""), 
            row.names = FALSE, append = FALSE, quote = FALSE, sep = ",")
...
write.table(model.csv, file = paste(out.dir,  name, "_ModelComparison2.csv", sep = ""), 
            row.names = FALSE, append = FALSE, quote = FALSE, sep = ",")
