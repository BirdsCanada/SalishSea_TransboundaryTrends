...
write.table(trends.csv, file = paste(out.dir, 
                                     site, "_TrendsEndpoint2", ".csv", sep = ""), 
            row.names = FALSE, append = FALSE, quote = FALSE, sep = ",")

#Slope Trends
write.table(trends.csv, file = paste(out.dir, 
                                     site, "_TrendsSlope2", ".csv", sep = ""), 
            row.names = FALSE, append = FALSE, quote = FALSE, sep = ",")
...
write.table(dispersion.csv, file = paste(out.dir,  site, "_DispersionStat2.csv", sep = ""), 
            row.names = FALSE, append = FALSE, quote = FALSE, sep = ",")
...
write.table(model.csv, file = paste(out.dir,  site, "ModelComparison2.csv", sep = ""), 
            row.names = FALSE, append = FALSE, quote = FALSE, sep = ",")
