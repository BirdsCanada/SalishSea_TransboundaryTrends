...
-   For a guild-specific analysis, select the guild you wish to analyse, and the species will be used as a random effect in the model.
...
#Here, the minimum data required across routes with at least one detection, each species needs an overall abundance per year > 10, need to be detected in > one-half of the survey years, and on > 10 survey sites. Users may choose to adjust these parameters. 
