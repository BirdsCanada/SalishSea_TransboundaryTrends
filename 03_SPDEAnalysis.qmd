...
**You do not need to run this code chunk if doing a species specific analysis**
...
#Set the distributional assumption. For the guild level analysis, we select 'poisson' but this may need to be adjusted. 
...
#e.g., Area_Species, Area_guild
name<-"Salish_Sea_AllSpecies"
