...
# 1. Modeling sea duck trends in the transboundary waters of the Salish Sea: a multi-scale approach to meet management planning needs.
...
Minimum data requirements are set. 
